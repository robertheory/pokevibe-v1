...
import './styles.css'
import PokemonName from '../Pokedex/PokemonName'
...
export default function PokedexResult(props) {
    ...
    useEffect( () => {
        ...
        pokeapi.get(props.source).then(response => {
            ...
            // console.log("Response.data: " + [...response.data.stats].map(item => {return item.stat.name}))
    ...
    return(
        ...
        <div className="pokedex">
            ...
            <div className="panel left-panel">
                ...
                <PokemonName name={name} id={id}></PokemonName>
